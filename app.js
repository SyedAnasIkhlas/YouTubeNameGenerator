...
document.addEventListener("copy", (event) => {
  console.log(event);
  createModal(
    `Checkout <a href="https://tiktoknamegenerator.ml" target="_blank">TikTok</a> name generator.`
  );
});
...
function generateNames(keyword, space, shuffle) {
  ...
  shortCell.innerHTML = `<a href="https://www.youtube.com/results?search_query=${short}&sp=EgIQAg%253D%253D" target="_blank">${short}</a>`;
